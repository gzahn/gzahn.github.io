...
Just as Evolution is the capstone course for Biology majors, Molecular Evolution and Bioinformatics is the capstone course for Biotechnology majors. At the end of the semester, you should be able to

  - Interpret bioinformatic problems within the framework of core bioinformatics concepts.
  - Critique existing bioinformatic pipelines and tools.
  - Create solutions to bioinformatics problems with existing or new tools.
  - Develop reproducible pipelines capable of successfully addressing chosen solutions.
  - Present fully-reproducible reports of bioinformatic analyses.

Computation: I highly suggest that you bring your own laptop.

Course Pre-requisites: Senior status in the Bioinformatics program
...
Define a capstone project. Work closely with Instructor and/or faculty mentor to complete course outcomes. Prepare and deliver presentation at scientific meeting (UCUR, UVU Showcase, National meeting, etc.) or other appropriate venue (department seminar, department poster session, etc.).

You can bring your own research project or work with the instructor and/or other faculty to develop one. Your project should address the learning outcomes above.

Your grade will be based on 50 points for participation and 50 points for your final presentation.
