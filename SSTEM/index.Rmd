...
#### [Course Syllabus](https://gzahn.github.io/SSTEM/media/syllabus.html){target="_blank"}
...
**Topics:** 
  ...
  - Discussion with [Dr. Faye Smith](http://www.drsoil.org/){target="_blank"} (Postdoc at USDA/ARS)
...
**Resources**
  ...
  - Funded SAC [example](https://gzahn.github.io/SSTEM/media/SAC_Example.pdf){target="_blank"}
  - Funded URSCA [Example](https://gzahn.github.io/SSTEM/media/URSCA_Example.pdf){target="_blank"}
...
**Resources**
  ...
  - An illegal way to get papers you don't have access to is [SciHub](https://www.google.com/search?channel=fs&client=ubuntu&q=sci-hub){target="_blank"} (I would never advocate this behavior though)
