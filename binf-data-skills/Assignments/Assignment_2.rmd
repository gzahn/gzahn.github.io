...
**2. Work through Chapter 2, typing all the code examples from the text into your own terminal. (Example data used in the chapter can be found in the supplemental repository online)**

  + Every line in the book in courier font that begins with '$' denotes a line of code that you can try on your own computer!
  
For example (you don't need to type the '$'):
