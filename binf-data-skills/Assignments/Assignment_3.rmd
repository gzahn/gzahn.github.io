...
**12. The following lines of code are out of order. Rearrange them and use pipes to link them together into one line of code that displays the total number of DNA sequences in all 3 files (should be 151).**
