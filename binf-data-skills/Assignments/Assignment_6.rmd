...
___
  ...
  **7.  Okay, now download this other [fasta file](https://gzahn.github.io/binf-data-skills/Data/Assignment_6_File_2.fasta.gz) (Assignment_6_File_2.fasta.gz) ... get it uncompressed. This file is essentially the same as the first filw, but the fasta headers contain taxonomic assignments for each sequence in the format: Kingdom;Phylum;Class;Order;Family;Genus**
