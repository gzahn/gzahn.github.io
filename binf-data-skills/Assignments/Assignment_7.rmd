...
#### **Job 2: Downloading surface glycoprotein sequences**
  ...
  + Tasks:
    ...
    2. Use datasets to download just the surface glycoproteins (gene code is "S") from sars-cov-2 genomes deposited since 03/01/2021
      
      + That command should look like...
      
            PATH/TO/datasets download virus protein S --released-since 03/01/2021 --exclude-pdb --exclude-gpff
    3. Calculate the number of sequences you downloaded
    4. Calculate the number unique nucleotide variants for that gene 
...
#### **Job 3: Clustering those sequences**
  ...
  + Tasks:
    ...
    1. Run the following program on the cds.fna file of surface glycoproteins
    
      
                vsearch --cluster_fast test.fasta -id 0.97 --centroids centroids.fasta --consout consensus.fasta --msaout msa.fasta --profile cluster_profiles.txt
