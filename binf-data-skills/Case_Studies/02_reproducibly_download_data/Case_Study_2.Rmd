...
6. **Now, that was the type collection. Let's also download some more recent strains so we can compare the nucleotide and amino acid sequences for the "surface glycoprotein" between the two strains.** 
...
9. **Bundle those 4 files, along with documentation.txt, into an archive called "sars_cov2_Surface_Glycoprotein_Sequences.zip"**
...
11. **Report the number of unique Surface Glycoprotein DNA variants you found among these new strains (Since Jan 8, 2021)**
