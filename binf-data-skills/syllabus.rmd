...
### Office: SB243c  -- Hours by appointment
...
This course is designed to develop data skills for bioinformatics students with a focus on command-line usage and genetic sequencing data. The focus of this course is on time-tested skills for working with complex, large bioinformatics datasets that won't expire as new software or algorithms become available. This is a companion course to BIOL 3100, which focuses on data cleaning, analysis and visualization in R. Requires previous exposure to (not expertise with) Unix systems, Python, or R.
...
### Suggested Co-requisite: BIOL 3100

**Learning goals**
  Students completing this course should be able to:
  
  1.  Understand the basic principles of Unix computing
  2.  Install and figure out how to use new bioinformatics tools
  3.  Reproducibly access and download large sequencing datasets
  4.  Manipulate DNA sequence data
  5.  Build a properly organized and reproducible piepline
  6.  Develop a new bioinformatics tool
...
**_COVID-19 Considerations:_**
  
  The course is meeting entirely online. All lectures will be live-streamed and recorded.
  Use the course web page as a map of the semester, but also be sure to stay active on Canvas and our Slack channel!
  
  You should make *every* effort to be present for the live class sessions. There's really no substitute for being able to follow along and ask questions.  This class tends to have a high cognitive burden, at least at first. You're going to want to ask questions.	
...
#### **Points are based on:**
  ...
  * 10 Weekly Assignments - 20 pts *each*
...
These are available on our course website. They will generally consist of requiring you to complete a series of tasks as you work through a chapter of the textbook. Typically, you will push your completed task to your GitHub repository and there will be a place on Canvas for you to indicate that your repository is ready to grade. The first and last assignments are freeform writing pieces that will be turned in on Canvas.

### **Case Studies**

These will be short projects where we utilize the skills we've learned so far to complete a real bioinformatics task. The tasks will gradually become more complex as we gain a larger arsenal of tools. These will require critical sythesis of the skills we have learned, along with some self-directed learning. For instance, you may be required to read through program documentation and troubleshoot the specifics of how to use new software tools. See weekly schedule below for more details.
...
#### We will work through this textbook together in a slightly different chapter order than the way it is organized:

___

### **Week 1:** Ideology of 'Robust and Reproducible' Bioinformatics
...
### **Week 2:** Proper Project Organization
...
### **Week 4:** Working with Sequence Data
...
### **Week 5:** Combining Unix Skills and Command-Line Software
...
### **Week 7:** Unix Data Tools, Continued
...
### **Week 8:** Finding and Retrieving Data
...
### **Week 9:** Working with Remote Machines
...
### **Week 10:** Working with Remote Machines, Continued
...
### **Week 12:** Bioinformatics Shell Scripting
...
### **Week 14:** Running a Pipeline on a Remote Machine
...
### **Week 15:** Creating a Custom Bioinformatics Tool
...
**Assignments:**
  ...
  - **Assignment 10 -** Reflection piece on what you've learned, why it's important, and what next steps you'll take
  -
  -
