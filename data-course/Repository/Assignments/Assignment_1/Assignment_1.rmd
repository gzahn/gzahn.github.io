...
4.  Now clone the github page you created (The one called Data_Course_YOURLASTNAME)
  ...
  + You now have two new folders on your desktop. One called "Data_Course" and one called "Data_Course_YOURLASTNAME"
...
11. To get *FULL* credit, I want you to make 10 separate changes to this README file and commit and push each one in turn. You can use a basic text editor to make additional changes if you like. Add whatever you want to it 10 times, saving and committing and pushing between each change. **One of the changes you should make is that I want you to copy some course materials from "Data_Course" into your "Data_Course_LASTNAME" repository. You can click and drag them over there if you want. Whatever. But just take the following directories and copy them into your repository (then add/commit/push the new files to your online repo):**
