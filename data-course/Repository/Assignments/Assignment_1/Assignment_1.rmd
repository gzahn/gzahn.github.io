...
Copy your token and paste it into a text document. To set it as an "environment variable" enter the following in your command-line terminal, replacing TOKEN with the actual token you received (keep all quotes as-is):
