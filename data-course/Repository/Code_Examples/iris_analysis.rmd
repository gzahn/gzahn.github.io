...
Now, if you want to run a statistical test to see if Petal Width **really** is affected by Sepal Width and Iris Species, it's pretty simple once you know a few functions:
