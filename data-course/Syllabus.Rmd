...
*  how to deal with common genetic sequence data types
*  command-line computing skills and proper reporting

### Pre-requisites: BIOL1620

**Learning goals**
Students completing this course should be able to:

1.  Understand the basic principles of exploratory data analyses within R
2.  Import and clean up a variety of data types
3.  Select and apply appropriate hypothesis tests and statistical models
4.  Create high-quality visualizations 
5.  Generate reports that knit code and output for reproducible research
6.  Have basic command-line skills used for processing biological data
...
These are available on our course website. They will generally consist of requiring you to complete a task using R and to upload your code as an R script to Canvas. Some may vary. Any data sets required for the assignment will be on the course GitHub repository as well. Due dates are on the course website. These assignments will not be accepted for credit after the due date.

### **Exams**

These will take place at times indicated on the course website. They will be similar to the sorts of tasks on the precedent Weekly Assignments, and you will be "open book, open internet." You will have a fair amount of time to complete them, but don't get complacent. They will be uploaded to [**this repository**](https://github.com/gzahn/BIOL3100_Exams.git){target="_blank"} when they become available.

### **Final Project**

Beginning early in the semester, we will decide on individual projects based on personal interest. Working with instructor feedback, you will come up with a question that interests you and will identify a data set that can address that question. You will then apply the data exploration and visualization skills you learn in class to prepare a well-formatted report that contains all the code and results of your analyses. **Most importantly this project will require you to teach yourself new R skills using the resources we learn about (or any others). You will be required to learn analyses explicitly not covered in this course (Check the course schedule to see what we are covering), and to apply them correctly to your analysis and report.**
