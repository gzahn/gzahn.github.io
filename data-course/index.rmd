...
**Practice**
  ...
  - In the directory Data_Course/Data/data-shell/names/ there are a number of subdirectories and csv files. Find all of those csv files and store their full filepaths as a character vector.
