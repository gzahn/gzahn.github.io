...
**Assignments**
  ...
  - Make sure you have the following packages installed if you don't already:
    ...
    + *carData*
    + *RColorBrewer*
    + [*colorblindr*](https://github.com/clauswilke/colorblindr){target="_blank"} This one is "special" and not found on CRAN so click the link for install instructions.
