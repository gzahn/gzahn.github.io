...
### Graduate students should reach out to me well in advance of applying to the [Applied Science PhD Program](https://www.wm.edu/as/appliedscience/graduateprogram/). Appications for Fall admission are due early February. If you're interested in doing a PhD in my lab, I'd like to be in conversation with you about it the prior September, if possible.

See more info [here](https://www.wm.edu/as/appliedscience/graduateprogram/admission/).


### Undergraduate student applications are accepted on a rolling basis. Please feel free come by my office to chat with me to see what projects are available, or to propose a new one. Priority is given to students with 2 or more years left until graduation.
...
### If you need a reference letter from me, please see [these instructions](https://gzahn.github.io/lab/reference_letters.html)
