...
This course will also be an intensive introduction to scientific writing. You will become adept at using citation management tools, background research, collaborative writing, and editing. We will explore and use writing theory to learn how to tell an interesting and useful story from a data set.

_____

# Expectations and evaluation

Grades will be based on assignments and code/paper contributions
...
Since we are writing a scientific publication together, we have to all know what we're talking about with regard to foliar endophytic fungi (FEF). That means that all of us are going to be thinking about the bigger pictures of: 

  - how FEF move around
  - whether plants actively select FEF from the environment
  - habitat connectivity, patchiness, meta-communities
  - *etc.*
  
Part of thinking about a scientific topic, is persistently looking up papers that might be useful to help you understand it. So, with all that in mind...you are taking on a debt.

**You owe me a minimum of two papers per week, deposited into our Zotero Group Library (with a note).** These papers don't have to be immediately about FEF, though there will be plenty of those. They may be about the broader ecological theories we're dealing with, or a more detailed paper about a mathematical method we might be able to use. When we start writing, we will need to have all these papers kicking around in our brains to draw from. You don't need to spend an hour on each paper, but you do need to at least skim them to get a feel for whether they will be useful (and how), and how they will help our manuscript fit into the bigger scientific conversation.

Starting to write without first swimming deeply in the background material will lead to failure. Do NOT slack on this! All of us will be reading *many* papers all semester (at least at a cursory level). I'll help show you how to quickly mine a paper for usefulness.
