...
[**Slide culture**](https://www.youtube.com/watch?v=0RJKvTngF5s){target="_blank"}
  ...
  - Common mold morphology [slides](https://gzahn.github.io/mycology/media/Lab_8_Common_molds_Quandt_and_Spatafora.pdf){target="_blank"} from Alisha Quandt and Joey Spatafora
...
[**Spore prints and spore characteristics**](){target="_blank"}
  ...
  - How to collect aeiral spores on a slide: [method paper](https://www.mdpi.com/1999-4907/9/10/586){target="_blank"} and [video](https://twitter.com/i/status/1192858092020600833){target="_blank"} of slide dipping technique.


</br></br>


[**Insect-associated fungi**](){target="_blank"}

  - Housefly fungi
  - Insect agar-walk [method](https://www.mdpi.com/2075-4450/7/2/16/htm){target="_blank"}
...
[**Collecting and identifying macrofungi**](https://www.mushroomexpert.com/studying.html){target="_blank"} (**NO**, not for eating! You're not an expert, so don't take the risk.)
  ...
  - Resources for [finding](https://www.youtube.com/watch?v=LKF_pIY0Zpc){target="_blank"}, [collecting](https://mycoflora.org/index.php?option=com_sppagebuilder&view=page&id=18){target="_blank"}, and [documenting](https://mycoflora.org/index.php?option=com_sppagebuilder&view=page&id=19){target="_blank"} macrofungi in the field
...
There are really a ton of good resources already made for this particular project. We will go through this together as a class on a small scale:
  ...
  - [**Presentation**](https://youtu.be/XhdtsNKtCm4){target="_blank"} from UVU's Sam Doty about mushroom cultivation 
