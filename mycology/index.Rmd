...
This course section is entirely online. All assignments, quizzes, and exams will be turned in and taken on Canvas. My preferred contact method is our group MSTeams channel.
...
#### [Course Syllabus](https://gzahn.github.io/mycology/media/Syllabus_Sp_2021.pdf){target="_blank"}
...
<div style= "float:right;position: relative;top:10px">
```{r "week1", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week2", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week3", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week4", out.width = "250px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week5", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week6", out.width = "350px",echo=FALSE}
...
**Resources**
  ...
  - Lesson [video](https://youtu.be/rGP3HpxVfIc){target="_blank"} Part 2
...
<div style= "float:right;position: relative;top:10px">
```{r "week7", out.width = "350px",echo=FALSE}
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_7.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week7.odp){target="_blank"}
  - Lesson [video](https://youtu.be/BeTEzfWI0VU){target="_blank"} Part 1
  - Lesson [video](https://youtu.be/VnthPY2fNHc){target="_blank"} Part 2
  - Introduction to Plant Pathology [Textbook](https://gzahn.github.io/mycology/media/Intro_to_PlantPath_2003.pdf){target="_blank"}
  
**Videos**

  - Life cycle of wheat stem rust [video](https://youtu.be/AeuP5IYP5HA){target="_blank"}
  - Plant-Pathogen interactions [video](https://youtu.be/dxTQxJL38c8){target="_blank"}
...
<div style= "float:right;position: relative;top:10px">
```{r "week8", out.width = "350px",echo=FALSE}
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_8.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week8.odp){target="_blank"}
  - Lesson [video](https://youtu.be/4IeNy2VaT48){target="_blank"} (Fungal Distributions)
  - AMF aerial dispersal [paper](https://nph.onlinelibrary.wiley.com/doi/abs/10.1111/nph.16667){target="_blank"}
  - Climate drives fungal distributions [paper](https://www.nature.com/articles/s41467-019-13164-8){target="_blank"}
  
**Videos**

  - Spore rain [video](https://youtu.be/Mrphn1zOWaE){target="_blank"}
  - Intercontinental spore travel [research talk](https://vimeo.com/440787285){target="_blank"} (~ 9 min)
...
<div style= "float:right;position: relative;top:10px">
```{r "week9", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week10", out.width = "350px",echo=FALSE}
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_9.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week9.odp){target="_blank"}
  - Lesson [video](https://youtu.be/FCRfD7ivYJY){target="_blank"} (Part 1 - Discuss Bacigalupe paper; Endophyte lesson)
  - Lesson [video](https://youtu.be/WZb4ppfSYSI){target="_blank"} (Part 2 - Discuss Christian et al, 2017 paper)
...
<div style= "float:right;position: relative;top:10px">
```{r "week11", out.width = "350px",echo=FALSE}
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_10.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week10.odp){target="_blank"}
  - Lesson [video](https://youtu.be/YoNcsXOkyVE){target="_blank"} (Recorded during class and posted after)
  - Best [overview paper](https://www.nature.com/articles/nrmicro.2016.149){target="_blank"} of ECM fungi ever!
...
___
  ...
  <div style= "float:right;position: relative;top:10px">
```{r "week12", out.width = "250px",echo=FALSE}
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_11.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week11.odp){target="_blank"}
  - Lesson [video](https://youtu.be/snEyT8goDKs){target="_blank"} (Discussion of paper)
...
<div style= "float:right;position: relative;top:10px">
```{r "week13", out.width = "350px",echo=FALSE}
...
**Readings and Assignments**
  ...
  - Read [Halvorson, et al., 2019](https://gzahn.github.io/mycology/media/Halvorson_et_al_2019.pdf){target="_blank"}
  - Listen to Halvorson, et al. [podcast](https://functionalecologists.com/2020/02/27/breaking-down-leaves-is-basically-hard-work-so-if-the-fungi-have-the-option-of-an-easier-life-they-take-it-ken-thompson-interviews-hal-halvorson-in-our-new-podcast/){target="_blank"} (~ 15 min)
  - Canvas quiz on readings (due before class Wednesday)
  - Teams discussion on readings (Wednesday 1pm)
...
<div style= "float:right;position: relative;top:10px">
```{r "week14", out.width = "350px",echo=FALSE}
...
<div style= "float:right;position: relative;top:10px">
```{r "week15", out.width = "350px",echo=FALSE}
...
=======
  - Canvas quiz on readings (due before class Wednesday)
  - Teams discussion on readings (Wednesday 1pm)
>>>>>>> f2c4e2ecfc5f26e2d7d1db8f065c2ec998ae970a
...
<div style= "float:right;position: relative;top:10px">
```{r "week16", out.width = "350px",echo=FALSE}
