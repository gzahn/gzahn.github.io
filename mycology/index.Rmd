...
#### [Text Book](https://gzahn.github.io/mycology/media/WEBSTER_and_WEBER_3rd-ed.pdf)
...
**Readings and Assignments**
  ...
  - Read Webster & Weber: **1.3** | **1.4** | **7.1** | **7.2** | **7.3.1** | **7.3.2**
  - Canvas quiz on readings
...
**Readings and Assignments**
  ...
  - Read [Glassman, et al., 2017](https://gzahn.github.io/mycology/media/Glassman_et_al_2017.pdf)
...
___
  ...
  <div style= "float:right;position: relative;top:10px">
```{r, out.width = "250px",echo=FALSE}
knitr::include_graphics("./media/rot_fungi_ecosystem.pdf")
```
</div>
