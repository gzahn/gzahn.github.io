...
The course is broken into 4 rough sections:
  ...
  1. Getting to know fungal biology and major groups (get ready for a bunch of terminology)
...
**Resources**
  ...
  - Lesson [video]() (Recorded during class and posted after)
...
**Readings and Assignments**
  ...
  - Canvas quiz on readings  (due before class Thursday)
  - Slack discussion on readings (Thursday 11:15am)
  - Turn in your Zygomycete photos (Canvas)
...
**Resources**
  ...
  - [Major Topics](https://gzahn.github.io/mycology/study_topics/week_3.txt){target="_blank"}
  - Leson [slides](https://gzahn.github.io/mycology/lectures/Week_4.odp){target="_blank"}
  - Lesson [video](){target="_blank"} (Recorded during class and posted after)
  - Basidiomycete [life cycle](){target="_blank"}
  - Basidiomycete [phylogeny](){target="_blank"}
  - [Pleurotus](){target="_blank"}
  - [Lycoperdon](){target="_blank"}
  - [Tremella](){target="_blank"}
...
**Readings and Assignments**
  ...
  - Fungal collections (5 types) and IDs (Turned in on Canvas next week)
