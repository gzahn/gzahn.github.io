...
Much of the course will involve laboratory work. The graded assignments will be announced in class and detailed instructions will be uploaded to Canvas. The bulk of these points will come from participation in culturing, DNA, and identification work in-class. Examples of these assignments include: 
...
**Research project options:**
  ...
  + Fungal endophyte diversity along an elevation gradient
  + Fungal heat-shock protein function for secondary stresses
  + Aquatic fungal survey (lakes and rivers)
  + Fungal antibiotic bioprospecting for MRSA antagonism
  + Experimental evolution of alcohol tolerance in yeast
