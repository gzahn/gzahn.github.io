...
pagetitle: Zahn Lab - Publications
---
...
```{r echo=FALSE,message=FALSE,warning=FALSE, fig.height=.2,fig.width=.2,fig.align='center'}
knitr::include_graphics("../media/wordcloud_research.png")
```
...
**Miller, I. P., Laney, A. G., Zahn, G., Sheehan, B. J., Whitley, K. V., & Kuddus, R. H. (2024). Isolation and preliminary characterization of a novel bacteriophage vB_KquU_φKuK6 that infects the multidrug-resistant pathogen Klebsiella quasipneumoniae. Frontiers in Microbiology, 15. https://doi.org/10.3389/fmicb.2024.1472729**

I don't know much about phages, but I can assemble and annotate genomes like a champ...so I did. This particular phage has theraputic potential against *Klebsiella quasipneumoniae*, which is cool!

___

**Wainwright, B. J., Leon, J.^†^, Vilela, E.^†^, Hickman, K. J. E.^†^, Caldwell, J.^†^, Aimone, B.^†^, Bischoff, P.^†^, Ohran, M.^†^, Morelli, M. W.^†^, Arlyza, I. S., Marwayana, O. N., & Zahn, G. (2024). Wallace’s line structures seagrass microbiota and is a potential barrier to the dispersal of marine bacteria. Environmental Microbiome. https://doi.org/10.1186/s40793-024-00568-3**

Cryptic dispersal barriers can affect bacterial assemblages in seagrasses. Wallace's Line, separates distinct bacterial community structures in the Indonesian Archipelago. Since cryptic dispersal barriers exist for bacteria in this region, this may have implications for the biogeography of macroorganisms that depend on these microbes.

___


**Hickman, K. J. E.^†^, & Zahn, G. (2024) Ten simple rules for leading a successful undergraduate-intensive research lab. PLOS Computational Biology. https://doi.org/10.1371/journal.pcbi.1011994**
...
**Watmough, S., Gilbert-Parkes, S., Basiliko, N., Lamit, L. J., Lilleskov, E. A., Andersen, R., … Zahn, G. (2022). Variation in carbon and nitrogen concentrations among peatland categories at the global scale. PLOS ONE, 17(11), e0275149. https://doi.org/10.1371/journal.pone.0275149**

Global-scale survey of peatland C and N reveals that broadly classified peatland categories have predictable C and OM concentrations. This adds needed resolution to climate models using land cover assessment for global C and N stocks.
